...
class GuesserActivity : BaseActivity<GuesserMVP.GuesserView>(), GuesserMVP.GuesserView {
    ...
    override fun draw(point: Point) {
        ...
        val motionEvent = MotionEvent.obtain(System.currentTimeMillis(), System.currentTimeMillis(), point.motionEvent, point.x*imageView.bitmapWidth, point.y*imageView.bitmapHeight, 0)
